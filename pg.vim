...
" Comments
syn keyword	pgTodo			TODO CHANGEME FIXME XXX BUG IMPORTANT contained
...
syn keyword pgKeyword	role reindex release reset rollback references row rows rowtype rule restrict
